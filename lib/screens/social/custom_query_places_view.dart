...
/// List view showing discovered places for a custom query.
class CustomQueryPlacesView extends ConsumerStatefulWidget {
  const CustomQueryPlacesView({
    super.key,
    required this.query,
  ...
  @override
  ConsumerState<CustomQueryPlacesView> createState() => _CustomQueryPlacesViewState();
}

class _CustomQueryPlacesViewState extends ConsumerState<CustomQueryPlacesView> {
  ...
  Widget build(BuildContext context) {
    final placesAsync = ref.watch(discoveredPlacesByQueryProvider(widget.query));
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'AI is searching for "${widget.query}" near you',
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 16),
          FilledButton.icon(
            onPressed: () => ref.invalidate(discoveredPlacesByQueryProvider(widget.query)),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 16),
          Text(
            'No places found for "${widget.query}"',
            style: theme.textTheme.titleSmall?.copyWith(
              fontWeight: FontWeight.w500,
            ),
            textAlign: TextAlign.center,
